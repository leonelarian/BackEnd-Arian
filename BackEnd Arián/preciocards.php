...
<br>
    <h2>2.c.</h2>
    <br>
  <button type="submit"><a href="listarencards.php">Inicio</a></button>
  <button type="submit"><a href="listar.php">Listar ropa</a></button>
  <button type="submit"><a href="buzocards.php">Buzo</a></button>
  <button type="submit"><a href="marcacards.php">Marca</a></button>
  <button type="submit"><a href="preciocards.php">Precio</a></button>
  <h2>Lista de ropa</h2>
